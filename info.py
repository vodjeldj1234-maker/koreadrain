...
SERVICES = {
    ...
    # 40째방 (2026-09-21) — 렉산 · 캐노피. 아파트 얘기를 쓴다 (문의가 절반 넘는다). 단지명은 안 쓴다.
    "렉산": {
        "dir": "lexan/info", "home": "/lexan/",
        "list_h1": "렉산 · 캐노피 정보글",
        "list_desc": "렉산 지붕을 부분만 갈아도 되는 경우와 전체를 갈아야 하는 경우, 단판과 복층렉산의 차이, 캐노피 설치 순서까지 현장에서 실제로 겪은 것만 정리했습니다.",
        "cta_sub": "지붕 · 캐노피 전체 · 깨진 곳이나 새는 자리 · 판과 덮개바 가까이 · 건물 외관",
        "cta_link": "시공 문의는 %s 렉산 · 캐노피 페이지에서",
        "fhome": "렉산 · 캐노피 시공 안내",
    },
}
